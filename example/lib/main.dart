...
import 'package:flutter_calendar_util/flutter_calendar_util.dart';
...
class MyHomePageState extends State<MyHomePage> {
  FlutterCalendarUtil _flutterCalendarUtil;
  ...
  MyHomePageState() {
    _flutterCalendarUtil = new FlutterCalendarUtil();
  }
              ...
              child: new ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return new EventItem(
                      _calendarEvents[index], _flutterCalendarUtil, () async {
      ...
      floatingActionButton: !(_selectedCalendar?.isReadOnly ?? true)
          ? new FloatingActionButton(
              onPressed: () async {
                ...
                final createEventResult = await _flutterCalendarUtil
  ...
  void _retrieveCalendars() async {
    try {
      ...
      final calendarsResult = await _flutterCalendarUtil.retrieveCalendars();
      setState(() {
  ...
  Future _retrieveCalendarEvents(String calendarId) async {
    try {
      ...
      final eventsResult = await _flutterCalendarUtil.retrieveEvents(
...
class EventItem extends StatelessWidget {
  ...
  final FlutterCalendarUtil _flutterCalendarUtil;
  ...
  EventItem(
      this._calendarEvent, this._flutterCalendarUtil, this.onDeleteSucceeded);
            ...
            child: new ButtonBar(
              children: <Widget>[
                new IconButton(
                  onPressed: () async {
                    final deleteResult =
                        await _flutterCalendarUtil.deleteEvent(
