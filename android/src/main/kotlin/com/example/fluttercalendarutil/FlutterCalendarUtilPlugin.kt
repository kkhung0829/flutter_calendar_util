...
const val CHANNEL_NAME = "flutter_calendar_util"


class FlutterCalendarUtilPlugin() : MethodCallHandler {
    ...
    val CALENDAR_NAME_ARGUMENT = "calendarName"
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar): Unit {
            ...
            val instance = FlutterCalendarUtilPlugin(registrar, calendarDelegate)
    ...
    override fun onMethodCall(call: MethodCall, result: Result): Unit {
        when (call.method) {
            ...
            RETRIEVE_CALENDAR_ID_METHOD -> {
                val calendarName = call.argument<String>(CALENDAR_NAME_ARGUMENT)

                _calendarDelegate.retrieveCalendarId(calendarName!!, result)
            }
